...
function synthesizeReviewedAnswer({ draftAnswer, review, sources, analysis, researchPlan }) {
  ...
  const conclusion = buildReviewedConclusion(draftAnswer, analysis, weakSources);
  const displayedConclusion = weakSources && conclusion.includes('공개 출처') ? conclusion : `${caveat}${conclusion}`;
